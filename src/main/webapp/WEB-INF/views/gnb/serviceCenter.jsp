...
<c:import url="../template/nav.jsp"/>
	<div class="container">
		<h3><span style="color: green;">스투비</span>&nbsp;고객센터</h3>
		<p style="color: #5d5d5d;">예약 단계별로 정리된 다음 FAQ를 확인후 해소되지 않는 문의사항은 하단의 상담원 문의를 통해 질문해주세요.</p>
		<div class="section marginTop50px" >
			<div class="tab">
				<ul>
					<li id="li_tab1" class="tab_active">입금대기</li>
					<li id="li_tab2">확정대기</li>
...
현금영수증 의무 발행업종</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-footer">네, 현재 스투비플래너는 카톡페이송금, 토스 송금, 은행 무통장입금만 지원하고 있습니다.
이는 카드 수수료를 줄여 고객의 불필요한 비용부담을 최소화하기 위한 스투비플래너의 선택입니다.
스투비는 최저가공급을 위해 지속적으로 노력하고 있으며, 최저가 상품이라 하더라도 상품에 따라 최대 8%의 추가 가격 할인혜택(얼리버드, 결합할인등)을 제공하고 있습니다.

만약 꼭 카드 결제가 필요할 경우, 스투비가 거래하는 유럽의 200개이상 현지업체들은 각자의 홈페이지에서 현지통화로 결제가 가능합니다. 다만 해당 홈페이지상에서 현지통화로 결제시 일반적으로 은행 환전 기준환율보다 불리한 카드사 기준 환율이 적용되며, 통화에 따라 이중 환전이 이루어질 수 있어 실제 결제금액은 예상금액보다 높을 수 있습니다.</div>
			</div>
			<!-- panel -->
			<div class="panel panel-default">
				<div class="panel-body">해외상품의 경우, 원화로 표기되는데 기준환율은 자체환율 기준이 있나요?</div>
				<div class="panel-footer">스투비의 기준환율은 외국환은행이 제공하는 매매기준 환율보다 낮은 수준으로 국내외 모든 업체의 기준환율보다 낮은 수준입니다.</div>
			</div>
			<!-- panel -->
			<div class="panel panel-default">
	...
	<!-- tab2 -->
		<div class="tab_contents" id="tab2">
			...
			<div class="panel panel-default">
				...
				<div class="panel-footer">스투비플래너는 고객님과 현지업체의 중개업자로서, 고객님이 예약 후 입금을 해 주셔야 투어 진행 의사가 있는 것으로 간주하고 현지업체에 확정을 요청할 수 있습니다. (단순 예약만으로는 투어 진행 의사를 확인하기 어렵습니다.)
...
2) 상품의 특성에 따라 현지 지불금으로 지불되어야 하는 금액이 있는 경우 해당 현지 지불금액의 환불에 대하여는 각 상품의 상세설명보기에서 별도로 고지한 취소환불 약관을 적용합니다. 상품페이지에 기재된 환불규정이 있을 경우, 해당 내용이 위의 내용보다 우선합니다.</div>
	...
	<h4 class="marginTop50px">스투비 맞춤여행 의뢰관련 문의</h4>
		<p style="color: #5d5d5d;">카톡 아이디 stubbyagent 로 연락주시거나 유선번호 02-886-0982 내선번호 1번으로 연락하셔서 고객님 성함을 알려주시면 담당플래너와 연결이 가능합니다.</p>
		
		<h4 class="marginTop50px">스투비플래너 서비스 이용 관련 문의</h4>
		<p style="color: #5d5d5d;"><a href="#" class="aNodeco">온라인 1:1 문의 게시판</a> 혹은 stubbyteam@gmail.com 으로 문의사항을 남겨주세요.</p>	
	</div>
