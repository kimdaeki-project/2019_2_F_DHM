...
<body>
	...
	<div class="swiper-container3"
		style="padding-top: 60px; margin-bottom: 20px; height: 600px; width: 100%; overflow: hidden;">
	...
	<div class="container" style="margin-top: -60px;">
		...
		<div class="row">
			<div class="jumbotron marginTop50px"
				style="width: 743px; float: left; margin-left: 20px;">
				...
				<div class="main_planner_btn_div">
					...
					</a> <input type="button" class="main_planner_btn_request"
						value="FUNDING">
				</div>
			</div>
		</div>
		...
		<div class="marginTop50px" style="clear: both;">
			...
			<div class="row">
				...
				<ul class="nav nav-tabs">
					<li class="index_buttons_li index_buttons_li"><a class="ac"
						data-toggle="tab" href="#home">최신</a></li>
					<li class="index_buttons_li" id="2"><a class="ac"
						data-toggle="tab" href="#menu2">커플/신혼</a></li>
					<li class="index_buttons_li" id="8"><a class="ac"
						data-toggle="tab" href="#menu8">남녀그룹</a></li>
					<li class="index_buttons_li" id="3"><a class="ac"
						data-toggle="tab" href="#menu3">부모님과</a></li>
					<li class="index_buttons_li" id="1"><a class="ac"
						data-toggle="tab" href="#menu1">아이들과</a></li>
					<li class="index_buttons_li" id="5"><a class="ac"
						data-toggle="tab" href="#menu5">여자혼자</a></li>
					<li class="index_buttons_li" id="6"><a class="ac"
						data-toggle="tab" href="#menu6">여자끼리</a></li>
					<li class="index_buttons_li" id="4"><a class="ac"
						data-toggle="tab" href="#menu4">남자혼자</a></li>
					<li class="index_buttons_li" id="7"><a class="ac"
						data-toggle="tab" href="#menu7">남자끼리</a></li>
				</ul>
						...
						<div class="swiper-container"
							...
							<div class="swiper-wrapper nolist">
								<c:forEach items="${newPlanner}" var="vo" varStatus="i">
									<div class="swiper-slide mp-li"
										style="height: 300px; overflow: hidden; float: left;">
												...
												<div class="mp-card">
													<div class="mp-p">
														<iframe
															...
															width="226px" height="207px" style="border: none;"></iframe>
														<div class="mp-info">
															<font style="color: #fff;">${vo.type}</font>
														</div>
													</div>
													<div class="mp-f">
														...
														<div class="mp-f2">
															<fmt:formatDate value="${deDate[i.index]}"
																pattern="yy년MM월dd일" />
															출발
														</div>
														<div class="mp-f3">
		...
		<div class="row">
			<div class="marginTop50px">
				...
				<ul class="nav nav-tabs">
					<li class="index_buttons_li"><a class="ac" data-toggle="tab"
						href="#f0">서울</a></li>
					<li class="index_buttons_li"><a class="ac" data-toggle="tab"
						href="#f1">인천</a></li>
					<li class="index_buttons_li"><a class="ac" data-toggle="tab"
								...
								<c:forEach items="${festival_seoul}" var="fe" varStatus="i">
									...
									<div style="width: 200px;" class="swiper-slide">
										<div style="position: relative; margin: 0 auto;">
											<div class="img-wrap" style="width: 0px;">
												<img class="wish-img" alt="여행사진" src="${fe.firstimage}">
											</div>
										</div>
										<div>
											...
											<div style="width: 20%; float: left; padding-top: 10px">
												<a onclick="clickinfo('${fe.title}')"> <i
													class="fa fa-info-circle"
													style="color: gray; font-size: 23px;"></i>
												</a>
											</div>
										</div>
									</div>
