		...
		<spring:form action="memberJoin" id="frm2" method="post" modelAttribute="memberVO">	
			<div class="Join4">
				...
				<div class="Join4-1-b">
					...
					<div class="Join-text">
						<label for="id"></label><spring:input path="id" class="Join4-3" placeholder="영문/숫자만 사용가능, 4~12자"/>
					</div>
				...
				<div class="Join4-1-b">
					...
					<div class="Join-text">
						<label for="pw"></label><spring:password path="pw" class="Join4-2" placeholder="영문/숫자만 사용가능, 4~12자"/>
					</div>
				</div>
				...
				<div class="Join4-1-b">
					...
					<div class="Join-text">
						<label for="pw2"></label><spring:password path="pw2" class="Join4-2" placeholder="영문/숫자만 사용가능, 4~12자"/>
					</div>
				</div>
