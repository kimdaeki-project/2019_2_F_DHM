...
<br>
<br>
주식회사 DHM플래너,주식회사 DHM익스피어리언스("회사" 또는 "DHM"라 함)는 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법, 통신비밀보호법, 전기통신사업법, 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.<br>
본 개인정보취급방침은 회사가 제공하는 DHM 및 DHM 관련 제반 서비스 (모바일 웹/앱 포함) 이용에 적용되며 다음과 같은 내용을 담고 있습니다.
<br>
<br>
개요<br>
(주)DHM플래너, (주)DHM익스피어리언스(이하 ‘회사'라 함)는 정보이용자(이하 ‘이용자'라 함)가 회사에서 제공하는 웹서비스, 모바일 어플리케이션 등 제반 서비스를 이용함에 있어, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 및 개인정보 보호법에 따라 이용자의 개인정보를 보호하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같은 처리방침을 두고 있습니다.<br>
<br>
<br>
...
<br>
2. 회사는 구글(Google)이 제공하는 웹 분석 서비스인 구글 애널리틱스(Google Analytics)를 이용하고 있습니다. 구글은 회사가 방문자가 사이트를 방문하여 어떻게 이용하는지 분석하는 도구를 제공함에 있어, 이용자에 대한 개인식별이 불가능한 수준의 정보(성별, 대략적인 연령대, 관심사에 관한 대략적인 정보 등)를 수집할 수 있습니다. <br>
회사와 구글은 구글 광고 쿠키, 익명 식별자, 구글 애널리틱스 쿠키 등을 이용하여 인구통계 정보 및 관심분야에 대한 정보를 수집하며, 이용자는 구글 애널리틱스 Opt-out Browser Add-on 을 이용하여 스스로를 구글의 프로그램에서 배제(opt-out)시킬 수 있습니다. 구글 애널리틱스 Opt-out Browser Add-on 은 https://tools.google.com/dlpage/gaoptout/를 방문하여 이용하실 수 있습니다.<br>
<br>
<br>
...
- 개인정보를 제공받는 자 : 주식회사 DHM익스피어리언스(635-81-01124) 및 항공/숙박/여행 상품 제공 업체<br>
...
- 개인정보 보호책임자<br>
성 명 : 전영재<br>
직 책 : (주)DHM플래너 대표, (주)DHM익스피어리언스 대표<br>
이메일 : dudwo123wjs@gmail.com<br>
주 소 : 서울 관악구 남부순환로 1837 샤론빌딩 4층 (주)DHM플래너<br>
<br>
...
- 대검찰청 첨단범죄수사과 (www.dhm.go.kr / 02-5882-8484)<br>
- 경찰청 사이버테러대응센터 (www.dhmc.go.kr / 02-5882-8484)<br>
<br>
...
<br>
2. 이 개인정보 처리방침은 2019년 11월 30일부터 적용됩니다.<br>
3. 이 개인정보 처리방침은 2020년 1월 1일부터 적용됩니다.<br>
<br>
</body>
</html>