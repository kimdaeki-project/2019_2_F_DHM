...
<h4>제1조 목적</h4>
<br>
 이 약관은 DHM(www.dhm.co.kr, www.dhmplanner.com, www.dhmtour.com) 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 현행 법령에 위반하지 않는 범위 내에서 회원의 기본적인 권리와 책임 및 당사와의 중요사항을 정하는 것을 목적으로 합니다.
<br>
<br>
<h4>제2조 용어의 정의</h4>
...
- '서비스'란 '회원'이 이용할 수 있는 DHM플래너 및 관련 제반 서비스를 의미합니다.<br>
...
(2) 이 약관은 '서비스제공자'가 DHM플래너를 통해 공시함으로서 효력을 발생합니다.<br>
...
<br>
'서비스 제공자'는 판매사업자에게 제공한 예약시스템상에서 '회원'이 예약한 정보를 '회원'의 '서비스'의 개선을 목적으로 이용합니다. 다만 '서비스 제공자'는 '판매사업자'의 동의아래 '판매사업자'에게 제공된 예약시스템 상에서 '회원'이 예약할때 해당 예약정보가 (DHM플래너)'서비스'에 제공됨을 명시해야합니다.<br>
<br><br>
<h4>제15조 회원의 게시물</h4>
<br>
...
단, 이 경우 '회원'은 언제든지 문의 게시판 또는 문의메일(hungsun@gmail.com)을 통해 해당 '게시물'대해 삭제, 비공개 등의 요청을 할 수 있습니다.<br>
...
<br>
부 칙<br>
본 약관은 2020년 1월 1일부터 적용됩니다.<br>
<br>
<br>
부 칙<br>
본 약관은 2020년 1월 19일부터 적용됩니다.<br>
<br>
<br>
부 칙<br>
본 약관은 2020년 1월 15일 수정되었습니다.<br>
수정사항은 2020년 2월 11일부터 시행됩니다.<br>
<br>
</body>
</html>