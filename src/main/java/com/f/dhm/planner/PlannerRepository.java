...
public interface PlannerRepository extends JpaRepository<PlannerVO2, Integer>{

	
	List<PlannerVO2> findById(String id);
	...
	List<PlannerVO2> findAllByOrderByPlStepDesc();
	...
	List<PlannerVO2> findByIdAndPlNum(String id,int plNum);
	...
	PlannerVO2 findByPlNum(int plNum) throws Exception;
