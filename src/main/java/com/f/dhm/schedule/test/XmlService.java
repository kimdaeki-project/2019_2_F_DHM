...
public class XmlService {
	...
	public Items parseTour() throws Exception{
		...
		Node node=null;
		String URL="http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=y6lTW%2Fe1nVt%2BwNPxKIPThO3llzEsDQDhLQAP%2B%2BUMAW%2BBCuZZLSXZiKKU0e966zEmm9vZCa84UyTdC1Y%2FA83LHQ%3D%3D&areaCode=1&MobileOS=ETC&MobileApp=AppTest";
...
//				  System.out.println("n"+j+" = " + elem.getElementsByTagName("areacode").item(0).getTextContent());
	...
	public Items searchTour(int arCode,int typeNum, String arr, int pageNum) throws Exception{
		...
		Items items=new Items();
		//혜현 인증키 : 5f%2Fbm26fN4EnlhTfrvyCPp0546ZP4TmM4rkpjz9XGPUpLaEHJcmmb2mJ7Gxl5UXrDIpBQ4%2BJ5ObMDF5nM22Qhg%3D%3D
		//성주 인증키 : KkW8cDTbMiDD70xS%2BpXe9JiQvVMyBa5TFeUylgBKuPAxfGxwOz4azNwFlyoQCuLua9hNxhoajrMdw8XV5pjo7w%3D%3D
